        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-primary mb-4">
              Алматинский Клуб Игровых Разработчиков АКИРА - это профессиональное сообщество, объединяющее разработчиков игр, художников, дизайнеров, композиторов, тестировщиков и геймеров в Алматы. Наша миссия - создать платформу для обмена знаниями, опытом и поддержкой среди тех, кто увлечен созданием игр.
            </p>
            <p className="text-primary mb-4">
