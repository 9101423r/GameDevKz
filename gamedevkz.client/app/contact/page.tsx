    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[50vh] w-full">
        ...
        >
          ...
          <p className="text-white/90 text-lg max-w-2xl">На случай, если понадобится коснуться</p>
        </motion.div>
      </section>
          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                answer:
                  "Нет, мы не берём клубных взносов или подписок, но некоторые наши мероприятия могут быть платными для оплаты аренды площадки.",
              },
              {
                question: "Вы обучаете игровой разработке?",
                answer:
                  "Нет, мы не занимаемся обучением и не проводим курсов, но вы всегда можете найти ментора, спросить совета и поучаствовать в образовательных воркшопах нашего клуба.",
              },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-primary max-w-2xl mx-auto">
              Здесь ты можешь найти прошедние и грядущие ивенты нашего клуба
            </p>
          </motion.div>
          <FeaturedCollections />
          <motion.div
